...
% - hgf_config
% - hgf_ar1_config
r.c_prc = hgf_binary3l_free_par_config;
...
r.c_obs = ioio_constant_weight_config; % ioio_constant_voltemp_config; % rp_voltemp_config;

% Optimization algorithm
% ~~~~~~~~~~~~~~~~~~~~~~
% Choices are:
% - quasinewton_optim_config
r.c_opt = quasinewton_allit_optim_config;
...
r.F = F;
r.d = d;
r.complexity = 1/2*log(1/det(H)) + d/2*log(2*pi); 
r.logLl = logLl;
