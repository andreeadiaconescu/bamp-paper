function c = bamp_ehgf_binary_ar1_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Undefined (therefore NaN) at the first level.
c.mmu = [NaN, c.mu_0mu(2), c.mu_0mu(3)]; % [NaN, c.mu_0mu(2), c.mu_0mu(3)];
c.msa = [NaN, 0,           1];
...
expectedLength = 5*c.n_levels+1*(c.n_levels-1);
...
c.prc_fun = @bamp_ehgf_binary_ar1;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @bamp_ehgf_binary_ar1_transp;
