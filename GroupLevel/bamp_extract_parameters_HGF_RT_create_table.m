...
for iSubject = 1:nSubjects
    ...
    variables_bamp{iSubject,3} = tmp.est_bamp.p_prc.m(3);
    variables_bamp{iSubject,4} = tmp.est_bamp.p_obs.ze1;
    variables_bamp{iSubject,5} = tmp.est_bamp.p_obs.ze2;
    variables_bamp{iSubject,6} = tmp.est_bamp.p_obs.be1;
    variables_bamp{iSubject,7} = tmp.est_bamp.p_obs.be3;
end
...
columnNames = [{'subjectIds'}, options.model.ar1, ResponseModel_Parameters];
