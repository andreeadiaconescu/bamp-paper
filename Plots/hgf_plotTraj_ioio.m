function hgf_plotTraj_ioio(r)
% Plots trajectories estimated by fitModel for the hfg_binary perceptual model
% Usage:  est = fitModel(responses, inputs); hgf_binary_plotTraj(est);
%
% --------------------------------------------------------------------------------------------------
...
% ylabel('\mu_2');
% hold off;
r.p_prc.th=exp(r.p_prc.om(3));
r.p_prc.mu2_0 = r.p_prc.mu_0(2);
subplot(2,1,2);
