...
xLimitArray    = {[-Inf Inf], [-Inf Inf], [-Inf Inf],[-Inf Inf],[-Inf Inf],[-Inf Inf],[-Inf Inf]};
yLimitArray    = {[-Inf Inf], [-Inf Inf], [-Inf Inf],[-Inf Inf],[-Inf Inf],[-Inf Inf],[-Inf Inf]};

parameterArray = yLabelArray;
nParameters    = size(parameterArray,2);
figure;
for iParameter = 1:nParameters
    subplot(2,4,iParameter);
