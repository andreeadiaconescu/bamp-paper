...
for  iSubject = 1:length(subjectsAll)
    ...
    advice{iSubject,1}  = tmp.behav_bamp.go_with_stable_helpful_advice;
    ...
    advice{iSubject,7}  = tmp.behav_bamp.go_with_stable_helpful_advice1;
    advice{iSubject,8}  = tmp.behav_bamp.go_with_stable_helpful_advice2;
    
    
    advice{iSubject,9}  = tmp.behav_bamp.take_adv_helpful;
    advice{iSubject,10}  = tmp.behav_bamp.go_against_adv_misleading;
